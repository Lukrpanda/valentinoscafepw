...
export async function infocontacto(page:Page){
...
export async function direccionenvio(page:Page){
...
export async function infopago(page:Page){
...
export async function finalizarcompra(page:Page){
